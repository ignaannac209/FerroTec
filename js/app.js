...
const platillos = () =>{
    ...
    mostrarPlatillos(ensaladas, pastas, pizzas, postres,bebidas, platillosArreglo);

}

const mostrarPlatillos = (ensaladas, pastas, pizzas, postres,bebidas, todos) =>{
...
document.addEventListener("DOMContentLoaded", function() {
    const toggleBarra = document.getElementById("toggleBarra");
